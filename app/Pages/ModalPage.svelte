...
export let newUpdate;

const addUpdate = (newPost):void => {
   
    newUpdate = {user: 'Lee', post: newPost, profilePic: "~/Images/blankProfilePic.png",
...
<page>
    ...
    <textField hint="post an update" class="-border" bind:text="{newPost}"></textField>
    ...
    <button on:tap={() => addUpdate(newPost)} text="Submit" class="-primary"></button>
    </stackLayout>
</page>
