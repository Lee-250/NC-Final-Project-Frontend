<script lang="typescript"> 
    ...
    let resources = [{user: 'Lee', profilePic: "~/Images/blankProfilePic.png", post: "I found this really useful", webURL: "https://www.youtube.com/watch?v=Z63w5PefxTQ"}, {user: 'Harry', profilePic: "~/Images/blankProfilePic.png", post: 'great video', webURL: "https://www.youtube.com/watch?v=Z63w5PefxTQ"}]
        ...
        <stackLayout >
            <bottomNavigation>
                ...
                <tabContentItem class="layout">
                    <stackLayout >
                          <button on:tap="{() => {openModal()}}"text="Post" class="button"></button>
                          <webView src="https://www.youtube.com/watch?v=Z63w5PefxTQ"></webView>
    
                          
                        <!-- <listView height="500" margin="10" items="{resources}"> 
                        <Template let:item>
                            <stackLayout >
                                <gridLayout columns="50, 50" rows="*, *">
                                    <image  col="0" row="0" class="-thumb img-circle" src="{item.profilePic}" />
