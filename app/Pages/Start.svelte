...
<page>
    <actionBar text="intro"></actionBar>
    <stackLayout>
            <label text="First time here?" fontSize="50"></label>
            <button on:tap="{() =>navigate({page: Info})}" text="Lets start"></button>
            <label text="Returning user" fontSize="50"></label>
